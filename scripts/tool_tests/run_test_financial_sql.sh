#!/bin/bash
# Wrapper script to run the financial SQL tool test within its virtual environment.
...
PYTHON_SCRIPT="$PROJECT_ROOT/scripts/tool_tests/test_financial_sql_tool.py"
