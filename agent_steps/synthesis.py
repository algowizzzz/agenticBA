...
class Synthesizer:
    ...
    def synthesize_answer(self, query: str, execution_results: Dict[str, Any]) -> str:
        ...
        if self.thinking_tracker:
            self.thinking_tracker.add_step("Synthesizing comprehensive answer from all gathered information...", "synthesis")
        ...
        try:
            ...
            if "direct_response" in execution_results and isinstance(execution_results["direct_response"], str):
                ...
                if self.thinking_tracker:
                    self.thinking_tracker.add_step("Using direct response with general knowledge", "synthesis")
            ...
            if self.thinking_tracker:
                if empty_results:
                    self.thinking_tracker.add_step("No relevant data found in tool results", "synthesis")
                else:
                    self.thinking_tracker.add_step("Assembling information from tool results into coherent answer", "synthesis")
